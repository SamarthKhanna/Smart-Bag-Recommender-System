# -*- coding: utf-8 -*-
"""Smart Bag - Predictionipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Oyr_vz8yrtGkKGvPCsKDjdpbvE1DGOW7
"""
...
def SmartBagRecommendations(user_number):
  with tempfile.TemporaryDirectory() as tmp:
    path = '/home/kushagra/GridRESTApi/dbcomm/Flipkart Grid/TFRS_model'
    ...
    ords = pd.read_csv('/home/kushagra/GridRESTApi/dbcomm/Flipkart Grid/orders.csv').drop(columns = ['Unnamed: 0'])
    ords['User'] = ords['User'].astype(str)
    ords['Item ID'] = ords['Item ID'].astype(str)

    # Loading the products data frame
    products = pd.read_csv('/home/kushagra/GridRESTApi/dbcomm/Flipkart Grid/products.csv').drop(columns = ['Unnamed: 0']) 
